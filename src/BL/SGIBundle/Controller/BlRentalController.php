...
use BL\SGIBundle\Form\BlRentalType;
...
class BlRentalController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $blRentals = $em->getRepository('SGIBundle:BlRental')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\SGIBundle\Form\BlRentalType', $blRental);
    ...
    {
        $deleteForm = $this->createDeleteForm($blRental);
        $editForm = $this->createForm('BL\SGIBundle\Form\BlRentalType', $blRental);
