...
use BL\SGIBundle\Entity\FieldsTrackComtrad;
use BL\SGIBundle\Form\FieldsTrackComtradType;
...
class FieldsTrackComtradController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $fieldsTrackComtrads = $em->getRepository('SGIBundle:FieldsTrackComtrad')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\SGIBundle\Form\FieldsTrackComtradType', $fieldsTrackComtrad);
    ...
    {
        $deleteForm = $this->createDeleteForm($fieldsTrackComtrad);
        $editForm = $this->createForm('BL\SGIBundle\Form\FieldsTrackComtradType', $fieldsTrackComtrad);
