...
use BL\SGIBundle\Entity\Billing;
use BL\SGIBundle\Form\BillingType;
...
class BillingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $billings = $em->getRepository('SGIBundle:Billing')->findAll();
    ...
    {
        $billing = new Billing();
        $form = $this->createForm('BL\SGIBundle\Form\BillingType', $billing);
    ...
    {
        $deleteForm = $this->createDeleteForm($billing);
        $editForm = $this->createForm('BL\SGIBundle\Form\BillingType', $billing);
