...
use BL\SGIBundle\Entity\Dashboard;
use BL\SGIBundle\Form\DashboardType;
...
class DashboardController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $dashboards = $em->getRepository('SGIBundle:Dashboard')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\SGIBundle\Form\DashboardType', $dashboard);
    ...
    {
        $deleteForm = $this->createDeleteForm($dashboard);
        $editForm = $this->createForm('BL\SGIBundle\Form\DashboardType', $dashboard);
