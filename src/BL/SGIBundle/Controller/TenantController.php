...
use BL\SGIBundle\Entity\Tenant;
use BL\SGIBundle\Form\TenantType;
...
class TenantController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tenants = $em->getRepository('SGIBundle:Tenant')->findAll();
    ...
    {
        $tenant = new Tenant();
        $form = $this->createForm('BL\SGIBundle\Form\TenantType', $tenant);
    ...
    {
        $deleteForm = $this->createDeleteForm($tenant);
        $editForm = $this->createForm('BL\SGIBundle\Form\TenantType', $tenant);
