...
use BL\SGIBundle\Entity\BlAtlinv;
use BL\SGIBundle\Form\BlAtlinvType;
...
class BlAtlinvController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $blAtlinvs = $em->getRepository('SGIBundle:BlAtlinv')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\SGIBundle\Form\BlAtlinvType', $blAtlinv);
    ...
    {
        $deleteForm = $this->createDeleteForm($blAtlinv);
        $editForm = $this->createForm('BL\SGIBundle\Form\BlAtlinvType', $blAtlinv);
