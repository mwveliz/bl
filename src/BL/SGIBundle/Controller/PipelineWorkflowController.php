...
use BL\SGIBundle\Entity\PipelineWorkflow;
use BL\SGIBundle\Form\PipelineWorkflowType;
...
class PipelineWorkflowController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pipelineWorkflows = $em->getRepository('SGIBundle:PipelineWorkflow')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\SGIBundle\Form\PipelineWorkflowType', $pipelineWorkflow);
    ...
    {
        $deleteForm = $this->createDeleteForm($pipelineWorkflow);
        $editForm = $this->createForm('BL\SGIBundle\Form\PipelineWorkflowType', $pipelineWorkflow);
