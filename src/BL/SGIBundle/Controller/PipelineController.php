...
use BL\SGIBundle\Entity\Pipeline;
use BL\SGIBundle\Form\PipelineType;
...
class PipelineController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pipelines = $em->getRepository('SGIBundle:Pipeline')->findAll();
    ...
    {
        $deleteForm = $this->createDeleteForm($pipeline);
        $editForm = $this->createForm('BL\SGIBundle\Form\PipelineType', $pipeline);
