...
use BL\SGIBundle\Entity\Twitterfollowup;
use BL\SGIBundle\Form\TwitterfollowupType;
...
class TwitterfollowupController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $twitterfollowups = $em->getRepository('SGIBundle:Twitterfollowup')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\SGIBundle\Form\TwitterfollowupType', $twitterfollowup);
    ...
    {
        $deleteForm = $this->createDeleteForm($twitterfollowup);
        $editForm = $this->createForm('BL\SGIBundle\Form\TwitterfollowupType', $twitterfollowup);
