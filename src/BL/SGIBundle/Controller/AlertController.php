...
use BL\SGIBundle\Entity\Alert;
use BL\SGIBundle\Form\AlertType;
...
class AlertController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $alerts = $em->getRepository('SGIBundle:Alert')->findAll();
    ...
    {
        $alert = new Alert();
        $form = $this->createForm('BL\SGIBundle\Form\AlertType', $alert);
    ...
    {
        $deleteForm = $this->createDeleteForm($alert);
        $editForm = $this->createForm('BL\SGIBundle\Form\AlertType', $alert);
