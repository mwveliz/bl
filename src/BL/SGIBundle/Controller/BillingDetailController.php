...
use BL\SGIBundle\Entity\BillingDetail;
use BL\SGIBundle\Form\BillingDetailType;
...
class BillingDetailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $billingDetails = $em->getRepository('SGIBundle:BillingDetail')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\SGIBundle\Form\BillingDetailType', $billingDetail);
    ...
    {
        $deleteForm = $this->createDeleteForm($billingDetail);
        $editForm = $this->createForm('BL\SGIBundle\Form\BillingDetailType', $billingDetail);
