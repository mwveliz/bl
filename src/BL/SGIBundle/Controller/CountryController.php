...
use BL\SGIBundle\Entity\Country;
use BL\SGIBundle\Form\CountryType;
...
class CountryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $countries = $em->getRepository('SGIBundle:Country')->findAll();
    ...
    {
        $country = new Country();
        $form = $this->createForm('BL\SGIBundle\Form\CountryType', $country);
    ...
    {
        $deleteForm = $this->createDeleteForm($country);
        $editForm = $this->createForm('BL\SGIBundle\Form\CountryType', $country);
