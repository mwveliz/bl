...
use BL\SGIBundle\Entity\FieldsTrackRental;
use BL\SGIBundle\Form\FieldsTrackRentalType;
...
class FieldsTrackRentalController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $fieldsTrackRentals = $em->getRepository('SGIBundle:FieldsTrackRental')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\SGIBundle\Form\FieldsTrackRentalType', $fieldsTrackRental);
    ...
    {
        $deleteForm = $this->createDeleteForm($fieldsTrackRental);
        $editForm = $this->createForm('BL\SGIBundle\Form\FieldsTrackRentalType', $fieldsTrackRental);
