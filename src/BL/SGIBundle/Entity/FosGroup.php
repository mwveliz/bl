...
class FosGroup
{
     ...
     * Add user
     *
     * @param \BL\SGIBundle\Entity\Usuario $user
     * @return FosGroup
     */
    public function addUser(\BL\SGIBundle\Entity\Usuario $user)
    {
        $this->user[] = $user;
     ...
     * @param \BL\SGIBundle\Entity\Usuario $user
     */
    public function removeUser(\BL\SGIBundle\Entity\Usuario $user)
    {
