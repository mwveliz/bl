...
function() {
            ...
            "r-tmpl": {
                ...
                parse: function(a, b, c, d, e, f) {
                    ...
                    if (-1 !== f.indexOf(a.templateId)) {
                        ...
                        for (var h = c(a.templateId), i = d.parse(h, c, null , a.context || null , f), j = 0; j < i.length; j++)
    ...
    b.RotorsInstance = D) : (b.newInstance = F,
    b.instanceClass = D,
    b.precompile = H,
    b.data = h)
}
