...
use BL\AppBundle\Entity\DashboardPosition;
use BL\AppBundle\Form\DashboardPositionType;
...
class DashboardPositionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $dashboardPositions = $em->getRepository('AppBundle:DashboardPosition')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\DashboardPositionType', $dashboardPosition);
    ...
    {
        $deleteForm = $this->createDeleteForm($dashboardPosition);
        $editForm = $this->createForm('BL\AppBundle\Form\DashboardPositionType', $dashboardPosition);
