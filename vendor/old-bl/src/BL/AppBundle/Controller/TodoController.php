...
use BL\AppBundle\Entity\Todo;
use BL\AppBundle\Form\TodoType;
...
class TodoController extends Controller
{
    ...
    {
        $todo = new Todo();
        $form = $this->createForm('BL\AppBundle\Form\TodoType', $todo);
    ...
    {
        $deleteForm = $this->createDeleteForm($todo);
        $editForm = $this->createForm('BL\AppBundle\Form\TodoType', $todo);
