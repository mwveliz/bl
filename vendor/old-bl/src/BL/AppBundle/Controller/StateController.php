...
use BL\AppBundle\Entity\State;
use BL\AppBundle\Form\StateType;
...
class StateController extends Controller
{
    ...
    {
        $state = new State();
        $form = $this->createForm('BL\AppBundle\Form\StateType', $state);
    ...
    {
        $deleteForm = $this->createDeleteForm($state);
        $editForm = $this->createForm('BL\AppBundle\Form\StateType', $state);
