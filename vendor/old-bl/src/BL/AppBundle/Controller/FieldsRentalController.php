...
use BL\AppBundle\Entity\FieldsRental;
use BL\AppBundle\Form\FieldsRentalType;
...
class FieldsRentalController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $fieldsRentals = $em->getRepository('AppBundle:FieldsRental')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\FieldsRentalType', $fieldsRental);
    ...
    {
        $deleteForm = $this->createDeleteForm($fieldsRental);
        $editForm = $this->createForm('BL\AppBundle\Form\FieldsRentalType', $fieldsRental);
