...
use BL\AppBundle\Entity\Bl;
use BL\AppBundle\Form\BlType;
...
class BlController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $bls = $em->getRepository('AppBundle:Bl')->findAll();
    ...
    {
        $bl = new Bl();
        $form = $this->createForm('BL\AppBundle\Form\BlType', $bl);
    ...
    {
        $deleteForm = $this->createDeleteForm($bl);
        $editForm = $this->createForm('BL\AppBundle\Form\BlType', $bl);
