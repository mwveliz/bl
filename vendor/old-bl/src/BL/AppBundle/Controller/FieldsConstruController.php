...
use BL\AppBundle\Entity\FieldsConstru;
use BL\AppBundle\Form\FieldsConstruType;
...
class FieldsConstruController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $fieldsConstrus = $em->getRepository('AppBundle:FieldsConstru')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\FieldsConstruType', $fieldsConstru);
    ...
    {
        $deleteForm = $this->createDeleteForm($fieldsConstru);
        $editForm = $this->createForm('BL\AppBundle\Form\FieldsConstruType', $fieldsConstru);
