...
use BL\AppBundle\Entity\Rental;
use BL\AppBundle\Form\RentalType;
...
class RentalController extends Controller
{
    ...
    {
        $rental = new Rental();
        $form = $this->createForm('BL\AppBundle\Form\RentalType', $rental);
    ...
    {
        $deleteForm = $this->createDeleteForm($rental);
        $editForm = $this->createForm('BL\AppBundle\Form\RentalType', $rental);
