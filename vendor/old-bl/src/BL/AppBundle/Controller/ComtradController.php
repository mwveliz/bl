...
use BL\AppBundle\Entity\Comtrad;
use BL\AppBundle\Form\ComtradType;
...
class ComtradController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $comtrads = $em->getRepository('AppBundle:Comtrad')->findAll();
    ...
    {
        $comtrad = new Comtrad();
        $form = $this->createForm('BL\AppBundle\Form\ComtradType', $comtrad);
    ...
    {
        $deleteForm = $this->createDeleteForm($comtrad);
        $editForm = $this->createForm('BL\AppBundle\Form\ComtradType', $comtrad);
