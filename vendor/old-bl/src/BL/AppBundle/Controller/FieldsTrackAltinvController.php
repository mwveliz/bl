...
use BL\AppBundle\Entity\FieldsTrackAltinv;
use BL\AppBundle\Form\FieldsTrackAltinvType;
...
class FieldsTrackAltinvController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $fieldsTrackAltinvs = $em->getRepository('AppBundle:FieldsTrackAltinv')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\FieldsTrackAltinvType', $fieldsTrackAltinv);
    ...
    {
        $deleteForm = $this->createDeleteForm($fieldsTrackAltinv);
        $editForm = $this->createForm('BL\AppBundle\Form\FieldsTrackAltinvType', $fieldsTrackAltinv);
