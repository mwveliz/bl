...
use BL\AppBundle\Entity\FieldsComtrad;
use BL\AppBundle\Form\FieldsComtradType;
...
class FieldsComtradController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $fieldsComtrads = $em->getRepository('AppBundle:FieldsComtrad')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\FieldsComtradType', $fieldsComtrad);
    ...
    {
        $deleteForm = $this->createDeleteForm($fieldsComtrad);
        $editForm = $this->createForm('BL\AppBundle\Form\FieldsComtradType', $fieldsComtrad);
