...
use BL\AppBundle\Entity\BlConstru;
use BL\AppBundle\Form\BlConstruType;
...
class BlConstruController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $blConstrus = $em->getRepository('AppBundle:BlConstru')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\BlConstruType', $blConstru);
    ...
    {
        $deleteForm = $this->createDeleteForm($blConstru);
        $editForm = $this->createForm('BL\AppBundle\Form\BlConstruType', $blConstru);
