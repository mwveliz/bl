...
use BL\AppBundle\Entity\FieldsAltinv;
use BL\AppBundle\Form\FieldsAltinvType;
...
class FieldsAltinvController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $fieldsAltinvs = $em->getRepository('AppBundle:FieldsAltinv')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\FieldsAltinvType', $fieldsAltinv);
    ...
    {
        $deleteForm = $this->createDeleteForm($fieldsAltinv);
        $editForm = $this->createForm('BL\AppBundle\Form\FieldsAltinvType', $fieldsAltinv);
