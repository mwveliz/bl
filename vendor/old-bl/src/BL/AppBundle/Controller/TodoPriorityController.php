...
use BL\AppBundle\Entity\TodoPriority;
use BL\AppBundle\Form\TodoPriorityType;
...
class TodoPriorityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $todoPriorities = $em->getRepository('AppBundle:TodoPriority')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\TodoPriorityType', $todoPriority);
    ...
    {
        $deleteForm = $this->createDeleteForm($todoPriority);
        $editForm = $this->createForm('BL\AppBundle\Form\TodoPriorityType', $todoPriority);
