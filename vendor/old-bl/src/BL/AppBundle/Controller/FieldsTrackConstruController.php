...
use BL\AppBundle\Entity\FieldsTrackConstru;
use BL\AppBundle\Form\FieldsTrackConstruType;
...
class FieldsTrackConstruController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $fieldsTrackConstrus = $em->getRepository('AppBundle:FieldsTrackConstru')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\FieldsTrackConstruType', $fieldsTrackConstru);
    ...
    {
        $deleteForm = $this->createDeleteForm($fieldsTrackConstru);
        $editForm = $this->createForm('BL\AppBundle\Form\FieldsTrackConstruType', $fieldsTrackConstru);
