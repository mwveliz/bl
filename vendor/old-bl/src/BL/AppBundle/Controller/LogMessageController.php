...
use BL\AppBundle\Entity\LogMessage;
use BL\AppBundle\Form\LogMessageType;
...
class LogMessageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $logMessages = $em->getRepository('AppBundle:LogMessage')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\LogMessageType', $logMessage);
    ...
    {
        $deleteForm = $this->createDeleteForm($logMessage);
        $editForm = $this->createForm('BL\AppBundle\Form\LogMessageType', $logMessage);
