...
use BL\AppBundle\Entity\PipelineNode;
use BL\AppBundle\Form\PipelineNodeType;
...
class PipelineNodeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pipelineNodes = $em->getRepository('AppBundle:PipelineNode')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\PipelineNodeType', $pipelineNode);
    ...
    {
        $deleteForm = $this->createDeleteForm($pipelineNode);
        $editForm = $this->createForm('BL\AppBundle\Form\PipelineNodeType', $pipelineNode);
