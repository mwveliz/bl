...
use BL\AppBundle\Entity\TrackConstru;
use BL\AppBundle\Form\TrackConstruType;
...
class TrackConstruController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $trackConstrus = $em->getRepository('AppBundle:TrackConstru')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\TrackConstruType', $trackConstru);
    ...
    {
        $deleteForm = $this->createDeleteForm($trackConstru);
        $editForm = $this->createForm('BL\AppBundle\Form\TrackConstruType', $trackConstru);
