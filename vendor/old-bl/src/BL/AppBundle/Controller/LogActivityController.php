...
use BL\AppBundle\Entity\LogActivity;
use BL\AppBundle\Form\LogActivityType;
...
class LogActivityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $logActivities = $em->getRepository('AppBundle:LogActivity')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\LogActivityType', $logActivity);
    ...
    {
        $deleteForm = $this->createDeleteForm($logActivity);
        $editForm = $this->createForm('BL\AppBundle\Form\LogActivityType', $logActivity);
