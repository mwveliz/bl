...
use BL\AppBundle\Entity\Country;
use BL\AppBundle\Form\CountryType;
...
class CountryController extends Controller
{
    ...
    {
        $country = new Country();
        $form = $this->createForm('BL\AppBundle\Form\CountryType', $country);
    ...
    {
        $deleteForm = $this->createDeleteForm($country);
        $editForm = $this->createForm('BL\AppBundle\Form\CountryType', $country);
