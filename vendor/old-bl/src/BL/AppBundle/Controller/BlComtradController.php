...
use BL\AppBundle\Entity\BlComtrad;
use BL\AppBundle\Form\BlComtradType;
...
class BlComtradController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $blComtrads = $em->getRepository('AppBundle:BlComtrad')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\BlComtradType', $blComtrad);
    ...
    {
        $deleteForm = $this->createDeleteForm($blComtrad);
        $editForm = $this->createForm('BL\AppBundle\Form\BlComtradType', $blComtrad);
