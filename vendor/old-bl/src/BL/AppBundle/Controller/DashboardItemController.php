...
use BL\AppBundle\Entity\DashboardItem;
use BL\AppBundle\Form\DashboardItemType;
...
class DashboardItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $dashboardItems = $em->getRepository('AppBundle:DashboardItem')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BL\AppBundle\Form\DashboardItemType', $dashboardItem);
    ...
    {
        $deleteForm = $this->createDeleteForm($dashboardItem);
        $editForm = $this->createForm('BL\AppBundle\Form\DashboardItemType', $dashboardItem);
