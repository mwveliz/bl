...
use BL\AppBundle\Entity\Constru;
use BL\AppBundle\Form\ConstruType;
...
class ConstruController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $construs = $em->getRepository('AppBundle:Constru')->findAll();
    ...
    {
        $constru = new Constru();
        $form = $this->createForm('BL\AppBundle\Form\ConstruType', $constru);
    ...
    {
        $deleteForm = $this->createDeleteForm($constru);
        $editForm = $this->createForm('BL\AppBundle\Form\ConstruType', $constru);
