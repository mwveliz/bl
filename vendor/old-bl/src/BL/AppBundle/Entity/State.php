...
class State
{
    ...
    /**
     * @var \BL\AppBundle\Entity\Country
     *
     * @ORM\ManyToOne(targetEntity="BL\AppBundle\Entity\Country")
     * @ORM\JoinColumns({
     ...
     * Set idCountry
     *
     * @param \BL\AppBundle\Entity\Country $idCountry
     * @return State
     */
    public function setIdCountry(\BL\AppBundle\Entity\Country $idCountry = null)
    {
     ...
     * Get idCountry
     *
     * @return \BL\AppBundle\Entity\Country 
     */
