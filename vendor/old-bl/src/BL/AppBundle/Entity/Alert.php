...
class Alert
{
    ...
    /**
     * @var \BL\AppBundle\Entity\LogMessage
     *
     * @ORM\ManyToOne(targetEntity="BL\AppBundle\Entity\LogMessage")
     * @ORM\JoinColumns({
     ...
     * Set idLog
     *
     * @param \BL\AppBundle\Entity\LogMessage $idLog
     * @return Alert
     */
    public function setIdLog(\BL\AppBundle\Entity\LogMessage $idLog = null)
    {
        $this->idLog = $idLog;
     ...
     * Get idLog
     *
     * @return \BL\AppBundle\Entity\LogMessage 
     */
